...
var _ = Describe("Config", func() {
	...
	DescribeTable("parse upstream string",
		...
		Entry("udp with port",
			"udp:4.4.4.4:531",
			Upstream{Net: "udp", Host: "4.4.4.4", Port: 531},
			false),
		Entry("udp without port, use default",
			"udp:4.4.4.4",
			Upstream{Net: "udp", Host: "4.4.4.4", Port: 53},
			false),
		Entry("tcp with port",
			"tcp:4.4.4.4:4711",
			Upstream{Net: "tcp", Host: "4.4.4.4", Port: 4711},
			false),
		Entry("tcp without port, use default",
			"tcp:4.4.4.4",
			Upstream{Net: "tcp", Host: "4.4.4.4", Port: 53},
			false),
